...
#define GM_MAX_ICEFLOOR 0//2
#define GM_MAX_CONVEYOR 0//2
#define GM_MAX_CONVEYOR_Y 2//2
#define CONVEYOR_SPEED 0//1

#define GM_MAX_TORNADO 0//3
...
#define GM_MAX_ENEMY_SOLDIER 1//3
