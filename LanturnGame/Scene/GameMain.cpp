...
void GameMain::Draw() const
{
	...
	if (life > 0) {
		...
		DrawBox(400, 220, 920, 500, 0xffffff, true);
		DrawString(630, 240, "Result", 0x000000);
		DrawFormatString(630, 350, 0x000000, "%06d", score);
		DrawString(520, 480, "--- Go to title with B button ---", 0x000000);
	}
